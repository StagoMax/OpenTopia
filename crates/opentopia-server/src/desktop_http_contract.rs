...
struct DesktopHttpResponsesV1 {
    ...
    list_flows: Vec<opentopia_core::ActiveFlowV1>,
    get_flow: opentopia_core::ActiveFlowV1,
    ...
    activate_flow_draft: opentopia_core::ActiveFlowV1,
    pause_flow: opentopia_core::ActiveFlowV1,
    resume_flow: opentopia_core::ActiveFlowV1,
    copy_flow: flows_api::FlowDraftView,
    ...
    invoke_flow: flow_cases_service::FlowCaseResult,
    dispatch_flow_event: Vec<flow_cases_service::FlowCaseResult>,
    list_flow_cases: Vec<opentopia_core::FlowCaseV1>,
    start_pending_flow_case: flow_cases_service::FlowCaseResult,
    supersede_pending_flow_case: opentopia_core::FlowCaseV1,
    list_flow_delivery_receipts: Vec<opentopia_core::WorkflowDeliveryReceiptV1>,
    retry_flow_delivery: opentopia_core::WorkflowDeliveryReceiptV1,
    list_flow_evaluations: Vec<opentopia_core::WorkflowEvaluationV1>,
    create_flow_evaluation: opentopia_core::WorkflowEvaluationV1,
    get_flow_evaluation_summary: flow_cases_service::FlowEvaluationSummary,
