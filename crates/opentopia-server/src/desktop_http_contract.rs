...
struct DesktopHttpResponsesV1 {
    ...
    retry_managed_office_runtime: OfficeRuntimeStatus,
    retry_managed_power_shell: ShellRuntimeStatus,
    ...
    get_agent_template_connection_access:
        agent_connection_access::AgentTemplateConnectionAccessView,
    ...
    list_agent_instances: Vec<AgentInstanceV1>,
    ...
    list_integration_definitions: Vec<opentopia_core::IntegrationDefinitionV1>,
    get_integration_definition: opentopia_core::IntegrationDefinitionV1,
    create_integration_definition: opentopia_core::IntegrationDefinitionV1,
    update_integration_definition: opentopia_core::IntegrationDefinitionV1,
    list_connections: Vec<opentopia_core::ConnectionV1>,
    get_connection: opentopia_core::ConnectionV1,
    create_connection: opentopia_core::ConnectionV1,
    update_connection: opentopia_core::ConnectionV1,
    test_connection: connections_api::TestConnectionResponse,
    refresh_connection_capabilities: connections_api::RefreshConnectionCapabilitiesResponse,
    list_connection_capability_revisions: Vec<opentopia_core::ConnectionCapabilityRevisionV1>,
    get_connection_capability_revision: opentopia_core::ConnectionCapabilityRevisionV1,
    ...
    list_workflow_deployments: Vec<opentopia_core::WorkflowDeploymentV1>,
    get_workflow_deployment: opentopia_core::WorkflowDeploymentV1,
    create_workflow_deployment: opentopia_core::WorkflowDeploymentV1,
    disable_workflow_deployment: opentopia_core::WorkflowDeploymentV1,
    start_deployed_workflow_run: opentopia_core::FlowRunV1,
    list_workflow_releases: Vec<opentopia_core::WorkflowReleaseV1>,
    get_workflow_release: opentopia_core::WorkflowReleaseV1,
    create_workflow_release: opentopia_core::WorkflowReleaseV1,
    invoke_workflow_release: workflow_automation_service::WorkflowInvocationResult,
    set_workflow_release_canary: opentopia_core::WorkflowReleaseV1,
    promote_workflow_release: opentopia_core::WorkflowReleaseV1,
    rollback_workflow_release: opentopia_core::WorkflowReleaseV1,
    disable_workflow_release: opentopia_core::WorkflowReleaseV1,
    dispatch_workflow_event: Vec<workflow_automation_service::WorkflowInvocationResult>,
    list_workflow_trigger_invocations: Vec<opentopia_core::WorkflowTriggerInvocationV1>,
    start_pending_workflow_invocation: workflow_automation_service::WorkflowInvocationResult,
    list_workflow_delivery_receipts: Vec<opentopia_core::WorkflowDeliveryReceiptV1>,
    retry_workflow_delivery: opentopia_core::WorkflowDeliveryReceiptV1,
    list_workflow_evaluations: Vec<opentopia_core::WorkflowEvaluationV1>,
    create_workflow_evaluation: opentopia_core::WorkflowEvaluationV1,
    get_workflow_evaluation_summary: workflow_automation_service::WorkflowEvaluationSummary,
    list_human_tasks: Vec<opentopia_core::HumanTaskV1>,
    get_human_task: opentopia_core::HumanTaskV1,
    resolve_human_task: human_tasks_api::ResolveHumanTaskResponse,
    claim_human_task: opentopia_core::HumanTaskV1,
    assign_human_task: opentopia_core::HumanTaskV1,
...
fn health_fixture() -> HealthResponse {
    HealthResponse {
        ...
        api_version: 2,
        office_runtime: opentopia_core::OfficeRuntimeStatus {
            runtime: Some(opentopia_core::OfficePythonRuntime {
                executable: PathBuf::from("python/python.exe"),
                root: PathBuf::from("office-runtime"),
                runtime_version: "python-3.12.14-openpyxl-3.1.5-r1".to_string(),
                python_version: "3.12.14".to_string(),
                openpyxl_version: "3.1.5".to_string(),
                source: opentopia_core::OfficeRuntimeSource::Packaged,
            }),
            managed_version: "python-3.12.14-openpyxl-3.1.5-r1".to_string(),
            managed_status: opentopia_core::ManagedOfficeRuntimeStatus::NotRequired,
            managed_error: None,
        },
