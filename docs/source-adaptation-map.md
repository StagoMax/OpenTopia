...
| OS sandbox | `crates/opentopia-core/src/sandbox.rs` | Codex 三平台隔离模型；Windows helper binary 直接复用 | strict/best-effort、backend preflight、network policy、状态描述；Windows 已做真实越界写拒绝测试 |
